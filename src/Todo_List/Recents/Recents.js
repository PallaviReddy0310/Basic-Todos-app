    ...
    <div className='mx-auto text-center'>
      ...
      <div className='row row-cols-1 row-cols-sm-2 row-cols-md-3'>
      {
        todos.map((todo)=><div key={todo.id} className='col mx-auto'>
          ...
          <p className='fs-3 lead' id='tHead'>{todo.task}</p>
          <p className='fs-5'>Start Time : {todo.startTime}</p>
          <p className='fs-5'>End Time : {todo.endTime}</p>
          <p className='fs-5'>Category : {todo.category}</p>
          <p className='fs-5'>Status : {todo.status}</p>
